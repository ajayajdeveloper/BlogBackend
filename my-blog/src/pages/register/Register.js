...
const handleSubmit = async (e) => {
  ...
  setError(false);
  try {
    const res = await axios.post("https://ajdev-blog.herokuapp.com/api/auth/register", {
      username,
      email,
      password,
    });
    ...
    return (
      ...
      <form className="registerForm" onSubmit={handleSubmit}>
        ...
        <button className="registerLoginButton"><Link className="link" to="/login">LOGIN</Link>
      </button>
